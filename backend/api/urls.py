...
from .views import DeleteLetterView,MarkLetterReadView,health, ResetPasswordView,VerifySessionView,LikedByView,RandomProfileView
urlpatterns = [
    ...
    path("randomprofile", RandomProfileView.as_view()),
]

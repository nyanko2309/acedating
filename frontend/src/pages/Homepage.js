    ...
    <div style={S.page}>
      ...
      <div style={S.topBar}>
        <div style={S.brand}>
          ...
          <div>
            <div style={S.brandTitle}>ace dating board</div>
            <div style={S.brandSub}>browse profiles • filter • favorite</div>
          </div>
        </div>

        <div style={S.statsPill}>
          <span style={S.dot} />
          <span style={S.statsText}>{initialLoading ? "Loading…" : `${totalPosts} results`} • v1.10</span>
        </div>
      </div>
      ...
      <div style={S.shell}>
        ...
        <div style={S.filtersCard}>
          <div style={S.filtersHeader}>
            <div>
              ...
              <div style={S.filtersHint}>All filters are multi-select. If you pick none, it means “any”.</div>
            </div>
        ...
        <div style={S.resultsHeader}>
          ...
          <div style={S.resultsMeta}>{initialLoading ? "Fetching profiles…" : `Showing ${totalPosts} of ${profiles.length}`}</div>
        </div>
        ...
        {initialLoading ? (
          ...
          <div style={S.empty}>
            ...
            <div style={S.emptyText}>Try clearing some filters, widening the age range, or searching fewer words.</div>
            <button type="button" style={S.secondaryBtn} onClick={clearFilters}>
              Clear all filters
            </button>
          </div>
